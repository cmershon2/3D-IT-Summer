...
public class twentyPin : MonoBehaviour {
    public bool rotate;
    public bool insert;
    ...
    void Update()
    {
        ...
        if (this.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("20pin_r"))
        {
        ...
        if (this.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("20pin_w"))
        {
            Destroy(menu);
