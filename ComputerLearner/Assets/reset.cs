...
public class reset : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (this.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("Reset_r"))
        {
            Zoom.GetComponent<Zoom>().psuBool = true;
        ...
        if (this.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("Reset_w"))
        {
            Destroy(menu);
